...
class BicycleCategoryFilterForm(forms.Form):
    ...
    def __init__(self, category=None, *args, **kwargs):
        ...
        self.fields["tyres_size"] = forms.ChoiceField(choices=TyreSize.choices, required=False, label="Tyres Size", widget=forms.RadioSelect)
        self.fields["size"] = forms.ChoiceField(choices=BicycleSize.choices, required=False, label="Frame Size", widget=forms.RadioSelect)
